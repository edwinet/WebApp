...
public partial class WebApp {
    ...
    {
        get => HttpData.Resolve<Restaurants>("restaurants");
        set => HttpData["restaurants"] = value;
    }

    /// <summary>
    /// Table class for restaurants
    /// </summary>
    public class Restaurants : DbTable, IQueryFactory
    {
        ...
        public Restaurants()
        {
            ...
            Name = "restaurants";
            Type = "TABLE";
            UpdateTable = "dbo.restaurants"; // Update Table
            DbId = "DB"; // DN
            ExportAll = false;
            ...
            id = new (this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("restaurants", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            _name = new (this, "x__name", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("restaurants", "_name", "CustomMsg"),
                IsUpload = false
            };
            ...
            description = new (this, "x_description", 203, SqlDbType.NText) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("restaurants", "description", "CustomMsg"),
                IsUpload = false
            };
            ...
            image = new (this, "x_image", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("restaurants", "image", "CustomMsg"),
                IsUpload = true
            };
            ...
            created_at = new (this, "x_created_at", 135, SqlDbType.DateTime) {
                ...
                CustomMessage = Language.FieldPhrase("restaurants", "created_at", "CustomMsg"),
                IsUpload = false
            };
            ...
            updated_at = new (this, "x_updated_at", 135, SqlDbType.DateTime) {
                ...
                DefaultErrorMessage = ConvertToString(Language.Phrase("IncorrectDate")).Replace("%s", DateFormat(11)),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("restaurants", "updated_at", "CustomMsg"),
                IsUpload = false
            };
            ...
            created_by = new (this, "x_created_by", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("restaurants", "created_by", "CustomMsg"),
                IsUpload = false
            };
            ...
            updated_by = new (this, "x_updated_by", 3, SqlDbType.Int) {
                ...
                DefaultErrorMessage = Language.Phrase("IncorrectInteger"),
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("restaurants", "updated_by", "CustomMsg"),
                IsUpload = false
            };
        ...
        public string DetailUrl
        {
            get {
                string detailUrl = "";
                if (CurrentDetailTable == "dishes" && dishes != null) {
                    detailUrl = dishes.ListUrl + "?" + Config.TableShowMaster + "=" + TableVar;
                    detailUrl += "&" + ForeignKeyUrl("fk_id", id.CurrentValue);
                }
                if (Empty(detailUrl))
                    detailUrl = "restaurantslist";
                return detailUrl;
            }
        }
        ...
        {
            if (SameString(pageName, "restaurantsview"))
                return Language.Phrase("View");
            else if (SameString(pageName, "restaurantsedit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "restaurantsadd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "RestaurantsView",
                Config.ApiAddAction => "RestaurantsAdd",
                Config.ApiEditAction => "RestaurantsEdit",
                Config.ApiDeleteAction => "RestaurantsDelete",
                Config.ApiListAction => "RestaurantsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "restaurantslist";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("restaurantsview", parm);
            else
                url = KeyUrl("restaurantsview", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "restaurantsadd";
        ...
        public string GetEditUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("restaurantsedit", parm);
            else
                url = KeyUrl("restaurantsedit", Config.TableShowDetail + "=");
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("restaurantslist", "action=edit"))); // DN
        ...
        public string GetCopyUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("restaurantsadd", parm);
            else
                url = KeyUrl("restaurantsadd", Config.TableShowDetail + "=");
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("restaurantslist", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("restaurantsdelete")); // DN
        ...
        {
            string pageName = "RestaurantsList";
        ...
        public async Task RenderListRow()
        {
            ...
            if (image.UseColorbox) {
                ...
                image.LinkAttrs["data-rel"] = "restaurants_x_image";
        ...
        public async Task WriteAuditTrailLog(string log) => await WriteAuditTrailAsync(CurrentUser(), log, "restaurants");
