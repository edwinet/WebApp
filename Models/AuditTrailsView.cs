...
public partial class WebApp {
    ...
    /// auditTrailsView
    /// </summary>
    public static AuditTrailsView auditTrailsView
    {
        get => HttpData.Get<AuditTrailsView>("auditTrailsView")!;
        set => HttpData["auditTrailsView"] = value;
    }

    /// <summary>
    /// Page class for audit_trails
    /// </summary>
    public class AuditTrailsView : AuditTrailsViewBase
    {
        // Constructor
        public AuditTrailsView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public AuditTrailsView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class AuditTrailsViewBase : AuditTrails
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "auditTrailsView";
        ...
        // Page name
        public string PageName => "audittrailsview";
        ...
        // Constructor
        public AuditTrailsViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "audittrailslist"; // Return to list
            }
                    ...
                    if (!IsModal) { // Normal view page
                        ...
                        if (TotalRecords <= 0) { // No record found // DN
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("audittrailslist"); // Return to list page
                            }
