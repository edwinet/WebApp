...
public partial class WebApp {
    ...
    /// restaurantsDelete
    /// </summary>
    public static RestaurantsDelete restaurantsDelete
    {
        get => HttpData.Get<RestaurantsDelete>("restaurantsDelete")!;
        set => HttpData["restaurantsDelete"] = value;
    }

    /// <summary>
    /// Page class for restaurants
    /// </summary>
    public class RestaurantsDelete : RestaurantsDeleteBase
    {
        // Constructor
        public RestaurantsDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public RestaurantsDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class RestaurantsDeleteBase : Restaurants
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "restaurantsDelete";
        ...
        // Page name
        public string PageName => "restaurantsdelete";
        ...
        // Constructor
        public RestaurantsDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("restaurantslist"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("restaurantslist"); // Return to list
                }
            }
