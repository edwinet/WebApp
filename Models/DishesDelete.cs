...
public partial class WebApp {
    ...
    /// dishesDelete
    /// </summary>
    public static DishesDelete dishesDelete
    {
        get => HttpData.Get<DishesDelete>("dishesDelete")!;
        set => HttpData["dishesDelete"] = value;
    }

    /// <summary>
    /// Page class for dishes
    /// </summary>
    public class DishesDelete : DishesDeleteBase
    {
        // Constructor
        public DishesDelete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public DishesDelete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class DishesDeleteBase : Dishes
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "dishesDelete";
        ...
        // Page name
        public string PageName => "dishesdelete";
        ...
        // Constructor
        public DishesDeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("disheslist"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("disheslist"); // Return to list
                }
            }
