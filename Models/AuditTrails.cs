...
public partial class WebApp {
    ...
    /// </summary>
    [MaybeNull]
    public static AuditTrails auditTrails
    {
        get => HttpData.Resolve<AuditTrails>("audit_trails");
        set => HttpData["audit_trails"] = value;
    }

    /// <summary>
    /// Table class for audit_trails
    /// </summary>
    public class AuditTrails : DbTable, IQueryFactory
    {
        ...
        public readonly DbField<SqlDbType> old_value;

        public readonly DbField<SqlDbType> new_value;
        ...
        public AuditTrails()
        {
            ...
            Name = "audit_trails";
            Type = "TABLE";
            UpdateTable = "dbo.audit_trails"; // Update Table
            DbId = "DB"; // DN
            ExportAll = false;
            ...
            id = new (this, "x_id", 3, SqlDbType.Int) {
                ...
                CustomMessage = Language.FieldPhrase("audit_trails", "id", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("id", id);
            ...
            created_at = new (this, "x_created_at", 135, SqlDbType.DateTime) {
                ...
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "<", "<=", ">", ">=", "BETWEEN", "NOT BETWEEN" },
                CustomMessage = Language.FieldPhrase("audit_trails", "created_at", "CustomMsg"),
                IsUpload = false
            };
            ...
            script = new (this, "x_script", 202, SqlDbType.NVarChar) {
                ...
                CustomMessage = Language.FieldPhrase("audit_trails", "script", "CustomMsg"),
                IsUpload = false
            };
            ...
            _username = new (this, "x__username", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("audit_trails", "_username", "CustomMsg"),
                IsUpload = false
            };
            ...
            _action = new (this, "x__action", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("audit_trails", "_action", "CustomMsg"),
                IsUpload = false
            };
            ...
            entity = new (this, "x_entity", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("audit_trails", "entity", "CustomMsg"),
                IsUpload = false
            };
            ...
            _field = new (this, "x__field", 202, SqlDbType.NVarChar) {
                ...
                InputTextType = "text",
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("audit_trails", "_field", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("field", _field);

            // key_value
            key_value = new (this, "x_key_value", 203, SqlDbType.NText) {
                Name = "key_value",
                ...
                MemoMaxLength = 255,
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("audit_trails", "key_value", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("key_value", key_value);

            // old_value
            old_value = new (this, "x_old_value", 203, SqlDbType.NText) {
                Name = "old_value",
                Expression = "[old_value]",
                UseBasicSearch = true,
                BasicSearchExpression = "[old_value]",
                DateTimeFormat = -1,
                VirtualExpression = "[old_value]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                MemoMaxLength = 255,
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("audit_trails", "old_value", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("old_value", old_value);

            // new_value
            new_value = new (this, "x_new_value", 203, SqlDbType.NText) {
                Name = "new_value",
                Expression = "[new_value]",
                UseBasicSearch = true,
                BasicSearchExpression = "[new_value]",
                DateTimeFormat = -1,
                VirtualExpression = "[new_value]",
                IsVirtual = false,
                ForceSelection = false,
                SelectMultiple = false,
                VirtualSearch = false,
                ...
                MemoMaxLength = 255,
                SearchOperators = new () { "=", "<>", "IN", "NOT IN", "STARTS WITH", "NOT STARTS WITH", "LIKE", "NOT LIKE", "ENDS WITH", "NOT ENDS WITH", "IS EMPTY", "IS NOT EMPTY", "IS NULL", "IS NOT NULL" },
                CustomMessage = Language.FieldPhrase("audit_trails", "new_value", "CustomMsg"),
                IsUpload = false
            };
            Fields.Add("new_value", new_value);
        ...
        public void LoadDbValues(Dictionary<string, object>? row)
        {
            ...
            try {
                ...
                old_value.DbValue = row["old_value"]; // Set DB value only
                new_value.DbValue = row["new_value"]; // Set DB value only
            } catch {}
        }
        ...
        {
            if (SameString(pageName, "audittrailsview"))
                return Language.Phrase("View");
            else if (SameString(pageName, "audittrailsedit"))
                return Language.Phrase("Edit");
            else if (SameString(pageName, "audittrailsadd"))
        ...
        public string GetApiPageName(string action)
        {
            return action.ToLowerInvariant() switch {
                Config.ApiViewAction => "AuditTrailsView",
                Config.ApiAddAction => "AuditTrailsAdd",
                Config.ApiEditAction => "AuditTrailsEdit",
                Config.ApiDeleteAction => "AuditTrailsDelete",
                Config.ApiListAction => "AuditTrailsList",
                _ => String.Empty
            };
        }
        ...
        // List URL
        public string ListUrl => "audittrailslist";
        ...
        public string GetViewUrl(string parm = "")
        {
            string url = "";
            if (!Empty(parm))
                url = KeyUrl("audittrailsview", parm);
            else
                url = KeyUrl("audittrailsview", Config.TableShowDetail + "=");
            return AddMasterUrl(url);
        }

        // Add URL
        public string AddUrl { get; set; } = "audittrailsadd";
        ...
        {
            string url = "";
            url = KeyUrl("audittrailsedit", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline edit URL
        public string InlineEditUrl =>
            AppPath(AddMasterUrl(KeyUrl("audittrailslist", "action=edit"))); // DN
        ...
        {
            string url = "";
            url = KeyUrl("audittrailsadd", parm);
            return AppPath(AddMasterUrl(url)); // DN
        }

        // Inline copy URL
        public string InlineCopyUrl =>
            AppPath(AddMasterUrl(KeyUrl("audittrailslist", "action=copy"))); // DN

        // Delete URL
        public string DeleteUrl => UseAjaxActions && Param<bool>("infinitescroll") && CurrentPageID() == "list"
            ? AppPath(KeyUrl(Config.ApiUrl + Config.ApiDeleteAction + "/" + TableVar))
            : AppPath(KeyUrl("audittrailsdelete")); // DN
        ...
        public void LoadListRowValues(DbDataReader? dr)
        {
            ...
            old_value.SetDbValue(dr["old_value"]);
            new_value.SetDbValue(dr["new_value"]);
        }

        // Render list content
        public async Task<string> RenderListContent(string filter)
        {
            string pageName = "AuditTrailsList";
        ...
        public async Task RenderListRow()
        {
            ...
            // key_value
            key_value.ViewValue = key_value.CurrentValue;
            key_value.ViewCustomAttributes = "";

            // old_value
            old_value.ViewValue = old_value.CurrentValue;
            old_value.ViewCustomAttributes = "";

            // new_value
            new_value.ViewValue = new_value.CurrentValue;
        ...
        public async Task RenderEditRow()
        {
            ...
            key_value.EditValue = key_value.CurrentValue; // DN
            key_value.PlaceHolder = RemoveHtml(key_value.Caption);

            // old_value
            old_value.SetupEditAttributes();
            old_value.EditValue = old_value.CurrentValue; // DN
            old_value.PlaceHolder = RemoveHtml(old_value.Caption);

            // new_value
            new_value.SetupEditAttributes();
            new_value.EditValue = new_value.CurrentValue; // DN
            new_value.PlaceHolder = RemoveHtml(new_value.Caption);
            ...
            if (!doc.ExportCustom) {
                ...
                if (doc.Horizontal) { // Horizontal format, write header
                    ...
                    if (exportType == "view") {
                        ...
                        doc.ExportCaption(old_value);
                        doc.ExportCaption(new_value);
                    } else {
                        doc.ExportCaption(id);
                        doc.ExportCaption(created_at);
                        doc.ExportCaption(script);
                ...
                if (recCnt >= startRec) {
                    ...
                    if (!doc.ExportCustom) {
                        ...
                        if (exportType == "view") {
                            ...
                            await doc.ExportField(old_value);
                            await doc.ExportField(new_value);
                        } else {
                            await doc.ExportField(id);
                            await doc.ExportField(created_at);
                            await doc.ExportField(script);
