...
public partial class WebApp {
    ...
    public static partial class Config
    {
        ...
        // Project
        public const string ProjectNamespace = "WebApp";

        public const string ProjectClassName = "WebApp.Models.WebApp"; // DN
        ...
        public const string ProjectName = "WebApp"; // Project name

        public static string ControllerName { get; set; } = "Home"; // Controller name // DN

        public const string ProjectId = "{89456192-A767-4B60-B043-591A4AA6A5D7}"; // Project ID (GUID)

        public static string RandomKey = "IJ4Mty1StbA3qq9c"; // Random key for encryption

        public static string EncryptionKey = ""; // Encryption key for data protection

        public static string ProjectStylesheetFilename = "css/webapp.css"; // Project stylesheet file name (relative to wwwroot)
        ...
        {
            new { Id = "es-ES", File = "spanish.xml" }
        };

        public static string LanguageDefaultId = "es-ES";
        ...
        // Table parameters
        public const string TablePrefix = "||WebAppReport||"; // For backward compatibility only
        ...
        public static string AuditTrailTableName = "audit_trails"; // Table name

        public static string AuditTrailTableVar = "audit_trails"; // Table var

        public static string AuditTrailFieldNameDateTime = "created_at"; // DateTime field name

        public static string AuditTrailFieldNameScript = "script"; // Script field name

        public static string AuditTrailFieldNameUser = "username"; // User field name

        public static string AuditTrailFieldNameAction = "action"; // Action field name

        public static string AuditTrailFieldNameTable = "entity"; // Table field name

        public static string AuditTrailFieldNameField = "field"; // Field field name

        public static string AuditTrailFieldNameKeyvalue = "key_value"; // Key Value field name

        public static string AuditTrailFieldNameOldvalue = "old_value"; // Old Value field name

        public static string AuditTrailFieldNameNewvalue = "new_value"; // New Value field name

        // Export Log
        public static string ExportPath = "export-89456192-a767-4b60-b043-591a4aa6a5d7"; // Export folder

        public static string ExportLogDbId = "DB"; // DB ID

        public static string ExportLogTableName = "export_logs"; // Table name

        public static string ExportLogTableVar = "export_logs"; // Table var

        public static string ExportLogFieldNameFileId = "file_id"; // File id (GUID) field name

        public static string ExportLogFieldNameDateTime = "created_at"; // DateTime field name

        public static string ExportLogFieldNameDateTimeAlias = "datetime"; // DateTime field name Alias

        public static string ExportLogFieldNameUser = "username"; // User field name

        public static string ExportLogFieldNameExportType = "export_type"; // Export Type field name

        public static string ExportLogFieldNameExportTypeAlias = "type"; // Export Type field name Alias

        public static string ExportLogFieldNameTable = "entity"; // Table field name

        public static string ExportLogFieldNameTableAlias = "tablename"; // Table field name Alias

        public static string ExportLogFieldNameKeyValue = "key_value"; // Key Value field name

        public static string ExportLogFieldNameFileName = "filename"; // File name field name

        public static string ExportLogFieldNameFileNameAlias = "filename"; // File name field name Alias

        public static string ExportLogFieldNameRequest = "request"; // Request field name
        ...
        public static string AdminUserName = "administrator"; // Administrator user name

        public static string AdminPassword = "Master0fpuppets"; // Administrator password
        ...
        public static bool UseModalRegister = true; // Use modal register
        ...
        public static string UserLevelTableName = "roles"; // User level (table name)

        public static string UserLevelIdFieldName = "id"; // Id (field name)

        public static string UserLevelNameFieldName = "role_name"; // Name (field name)

        public static string UserLevelTable = "dbo.roles"; // For SQL

        public static string UserLevelIdField = "id"; // For SQL

        public static string UserLevelNameField = "role_name"; // For SQL

        // User Level Permissions table/field
        public static string UserLevelPrivDbId = "DB"; // Database ID

        public static string UserLevelPrivTableName = "permissions"; // User level permissions (table name)

        public static string UserLevelPrivTableNameFieldName = "entity"; // Table name (field name)

        public static string UserLevelPrivUserLevelIdFieldName = "role_id"; // User level ID (field name)

        public static string UserLevelPrivPrivFieldName = "permission"; // Priv (field name)

        public static string UserLevelPrivTable = "dbo.permissions"; // For SQL

        public static string UserLevelPrivTableNameField = "entity"; // For SQL

        public static string UserLevelPrivUserLevelIdField = "role_id"; // For SQL
        ...
        public static string UserLevelFieldName = "role_id";

        public static string UserProfileFieldName = "profile";

        public static string RegisterActivateFieldName = "";

        public static string UserEmailFieldName = "email";

        public static string UserPhoneFieldName = "mobile";

        public static string UserImageFieldName = "photo";
        ...
        public static string UploadDestPath = "upload/"; // Upload destination path
        ...
        // Audit trail
        public static string AuditTrailPath = "Logs/"; // Audit trail path (relative to wwwroot)
        ...
        public static Dictionary<string, Type> NamedTypes = new ()
        {
            ...
            {"users", typeof(Users)},
            {"roles", typeof(Roles)},
            {"permissions", typeof(Permissions2)},
            {"permissions2", typeof(Permissions2)},
            {"audit_trails", typeof(AuditTrails)},
            {"export_logs", typeof(ExportLogs)},
        ...
        {
            new object[] { 10, "mi_restaurants", "10", "restaurantslist", -1, "", "{89456192-A767-4B60-B043-591A4AA6A5D7}restaurants", false, false, "fa-solid fa-utensils", "", false, true },
            new object[] { 17, "mi_dishes", "17", "disheslist?cmd=resetall", -1, "", "{89456192-A767-4B60-B043-591A4AA6A5D7}dishes", false, false, "fa-solid fa-bowl-rice", "", false, true },
            new object[] { 16, "mci_Admin_Panel", "16", "", -1, "", false, true, true, "", "", false, true },
            new object[] { 1, "mi_users", "1", "userslist", 16, "", "{89456192-A767-4B60-B043-591A4AA6A5D7}users", false, false, "", "", false, true },
            new object[] { 8, "mi_roles", "8", "roleslist", 16, "", "{89456192-A767-4B60-B043-591A4AA6A5D7}roles", false, false, "", "", false, true },
            new object[] { 6, "mi_audit_trails", "6", "audittrailslist", 16, "", "{89456192-A767-4B60-B043-591A4AA6A5D7}audit_trails", false, false, "", "", false, true },
            new object[] { 9, "mi_export_logs", "9", "exportlogslist", 16, "", "{89456192-A767-4B60-B043-591A4AA6A5D7}export_logs", false, false, "", "", false, true }
        };
