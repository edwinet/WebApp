...
public partial class WebApp {
    ...
    /// permissions2Delete
    /// </summary>
    public static Permissions2Delete permissions2Delete
    {
        get => HttpData.Get<Permissions2Delete>("permissions2Delete")!;
        set => HttpData["permissions2Delete"] = value;
    }

    /// <summary>
    /// Page class for permissions
    /// </summary>
    public class Permissions2Delete : Permissions2DeleteBase
    {
        // Constructor
        public Permissions2Delete(Controller controller) : base(controller)
        {
        }

        // Constructor
        public Permissions2Delete() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class Permissions2DeleteBase : Permissions2
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "permissions2Delete";
        ...
        // Page name
        public string PageName => "permissions2delete";
        ...
        // Constructor
        public Permissions2DeleteBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (Empty(filter))
                return Terminate("permissions2list"); // Prevent SQL injection, return to List page
            ...
            if (IsShow) { // Load records for display // DN
                ...
                if (TotalRecords <= 0) { // No record found, exit
                    CloseRecordset(); // DN
                    return Terminate("permissions2list"); // Return to list
                }
            }
