...
public partial class WebApp {
    ...
    /// dishesView
    /// </summary>
    public static DishesView dishesView
    {
        get => HttpData.Get<DishesView>("dishesView")!;
        set => HttpData["dishesView"] = value;
    }

    /// <summary>
    /// Page class for dishes
    /// </summary>
    public class DishesView : DishesViewBase
    {
        // Constructor
        public DishesView(Controller controller) : base(controller)
        {
        }

        // Constructor
        public DishesView() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class DishesViewBase : Dishes
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "dishesView";
        ...
        // Page name
        public string PageName => "dishesview";
        ...
        // Constructor
        public DishesViewBase(Controller? controller = null): this() { // DN
            if (controller != null)
        ...
        public override async Task<IActionResult> Run()
        {
            ...
            if (RouteValues.TryGetValue("id", out v) && !Empty(v)) { // DN
                ...
                returnUrl = "disheslist"; // Return to list
            }
