...
public partial class WebApp {
    ...
    /// dishesEdit
    /// </summary>
    public static DishesEdit dishesEdit
    {
        get => HttpData.Get<DishesEdit>("dishesEdit")!;
        set => HttpData["dishesEdit"] = value;
    }

    /// <summary>
    /// Page class for dishes
    /// </summary>
    public class DishesEdit : DishesEditBase
    {
        // Constructor
        public DishesEdit(Controller controller) : base(controller)
        {
        }

        // Constructor
        public DishesEdit() : base()
        {
        }
    }
    ...
    /// Page base class
    /// </summary>
    public class DishesEditBase : Dishes
    {
        // Page ID
        ...
        // Page object name
        public string PageObjName = "dishesEdit";
        ...
        // Page name
        public string PageName => "dishesedit";
        ...
        // Constructor
        public DishesEditBase(Controller? controller = null): this() { // DN
            if (controller != null)
                    ...
                    if (!IsModal) { // Normal edit page
                        ...
                        if (TotalRecords <= 0) { // No record found
                            ...
                            if (IsApi()) {
                                ...
                                return Terminate("disheslist"); // Return to list page
                            }
                ...
                case "show": // Get a record to display
                    if (!IsModal) { // Normal edit page
                        ...
                        if (!loaded) { // Load record based on key
                            ...
                            return Terminate("disheslist"); // No matching record, return to list
                        }
                    } // End modal checking
                    break;
