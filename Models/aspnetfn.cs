...
public partial class WebApp {
    ...
    public static object? Invoke(string name, object?[]? parameters = null) =>
        typeof(WebApp).GetMethod(name)?.Invoke(null, parameters);
    ...
    public static object? GetPropertyValue(string name) =>
        typeof(WebApp).GetProperty(name, BindingFlags.Public | BindingFlags.Static | BindingFlags.FlattenHierarchy | BindingFlags.Instance)?.GetValue(null);
